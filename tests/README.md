...
| `tests/sketches/freshness-badge-redesign.html` | Five redesigns of the program-page "UPDATED 2026.Q1" badge (`Breadcrumb.jsx` `freshness` prop): dossier stamp, masthead line, changelog tab, gutter mark, status pill + tooltip. Each shown as a pencil sketch on dark hero ground plus a live HTML/CSS micro-mock. |
